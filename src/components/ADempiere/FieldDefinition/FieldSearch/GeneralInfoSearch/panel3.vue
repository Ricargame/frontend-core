...
export default defineComponent({
  ...
  setup(props) {
    ...
    function showList(isShow) {
      if (isShow && isEmptyValue(optionsListBussines.value)) { filterSearchBusinnes(displayValue.value) } else if (isShow && isEmptyValue(optionsListOrder.value)) { filterSearchOrder(displayValue.value) }
    }
